...
SYSTEM_PROMPT = (
    ...
    "reviewing a patient's schedule-adjustment request. State whether it can proceed, what the "
    "conflict (if any) is, and whether a manual call is required. Be concise and factual — do not "
    "invent any information beyond what is given."
)
